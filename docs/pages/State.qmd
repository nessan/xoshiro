...
$$
This is useful because, as discussed [here][jump technique], if we know the polynomial $p(x)$ then we can very efficiently advance the state by enormous numbers of steps.
