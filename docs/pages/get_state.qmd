...
```
1. Create a pair of generators that are seeded from neighboring integers.
...
```
1. Seeded `g0` and `g1` with neighboring values. \
[*SplitMix64*][SplitMix] was used on those seeds to mix them up and get to very different underlying state arrays.
