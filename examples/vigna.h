// Here are the xoshiro/xoroshiro "C" implementations from the author's website.
//
...
// some signed/unsigned compiler comparison warnings we did change a few variables from `int` to `unsigned`. For the
...
//
// The originals all carry the following copyright notice:
